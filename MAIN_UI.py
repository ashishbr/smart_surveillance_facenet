...
win=Tk()
win.title("SMART HOME SURVEILLANCE")
...
label=Label(win,text=" Click below button to be safe",bg="black",fg="white",font=("times",25,"bold"))
label.place(x=700,y=250)

label=Button(win,text="Start Surveillance",bg="black",fg="white",font=("times",25,"bold"),command=run_file)
label.place(x=700,y=340)

label=Button(win,text="Enter_data",bg="black",fg="white",font=("times",25,"bold"),command=data)
label.place(x=700,y=440)

label=Button(win,text="Upload family photo",bg="black",fg="white",font=("times",25,"bold"),command=photo)
label.place(x=700,y=540)
